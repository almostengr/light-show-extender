...
namespace Almostengr.HpLightShow.WebApi.Features.StartSequence.Infrastructure;

public sealed class FppSequenceRepository : IFppSequenceRepository
{
    private readonly AppSettings _appSettings;

    public FppSequenceRepository(AppSettings appSettings)
    {
    ...
    public IList<SequenceRule> GetSequenceRules(int currentYear)
    {
        ...
        [
            ...
            new SequenceRule(new DateOnly(currentYear, 5, 24), new DateOnly(currentYear, 5, 31), LightingSequence.RedBlue, threeDayWeekend), // memorial day
            ...
            new SequenceRule(new DateOnly(currentYear, 4, 1), new DateOnly(currentYear, 4, 30), LightingSequence.Blue),
